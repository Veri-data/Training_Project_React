            ...
            <div className="border-b px-4 pb-6">
                <div className="text-center my-4">
                    <img className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4"
                        src="https://randomuser.me/api/portraits/women/21.jpg" altF="" />
                    <div className="py-2">
                        <h3 className="font-bold text-2xl text-gray-800 dark:text-white mb-1">Bienvenu, {name}</h3>
                ...
                <div className="flex gap-2 px-2">
                    ...
                    <Link to="/"><button
                        className="flex-1 rounded-full border-2 bg-red-600 dark:bg-red-800 border-gray-400 dark:border-gray-700 font-semibold text-white hover:bg-red-500 dark:hover:bg-red-700 px-4 py-2">
                        Disconnected
                    </button></Link>
                </div>
            </div>
